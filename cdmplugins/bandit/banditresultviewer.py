...
"""Codimension Bandit results viewer."""
...
class BanditResultViewer(QWidget):
    """Bandit results viewer."""
    ...
    def __init__(self, ide, pluginHomeDir, parent=None):
        ...
        self.__resultsTree.setHeaderLabels(["Line", "Severity", "Code", "Message"])
    ...
    def showResults(self, results):
        ...
        self.__ide.sideBars["bottom"].setTabToolTip("bandit", tooltip)
        ...
        if diagnostics:
            parent = QTreeWidgetItem([f"Security issues ({len(diagnostics)})", "", "", ""])
            ...
            item = QTreeWidgetItem(["", "", "", "No security issues found"])
            self.__resultsTree.addTopLevelItem(item)
