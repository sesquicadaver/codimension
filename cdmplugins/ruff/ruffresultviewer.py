...
"""Codimension ruff results viewer"""
...
class RuffResultViewer(QWidget):
    """Ruff results viewer."""
    ...
    def showResults(self, results):
        ...
        tooltip = " ".join(["ruff results for", os.path.basename(results["FileName"]), "at", results["Timestamp"]])
        self.__ide.sideBars["bottom"].setTabToolTip("ruff", tooltip)
