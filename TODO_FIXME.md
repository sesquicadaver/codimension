...
Підтверджених **P0** немає. **P1: 0**. **P2: 2** групи (P2-03 → R274; P2-05 → R275) → **R274–R275**. Хвиля R261–R268 закрита; зріз `codi-last.md` @ master@fdb29cad (Qt/QThread lifecycle).
...
| ID | Проблема | Пріоритет | Статус |
|----|----------|-----------|--------|
| P2-01 | Shutdown без централізованого quiescence barrier | P2 | ✅ R271 |
...
| P2-05 | AI explicit kwargs (`deadline_sec=NaN`/negative) не fail-closed як env parser | P2 | ✅ R268 |
