...
| 58 | R246 | Foreign URI boundary | Reject UNRESOLVED opens; canonical URI; fd-rooted loader | L | DONE |
...
**Next OPEN:** **R247** — MCP pre-materialization budgets (`max_entries` before full sort).
...
Wave **R244–R251** = hardening from re-audit `codi-last.md` @ 645d655 (master@cf241873; recommended queue §1–8).
