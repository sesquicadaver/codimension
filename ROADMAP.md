...
| 46 | R234 | LSP pending synchronization | `_pending_lock`; `(generation, id)` keys; timeout/shutdown/old-reader race tests | L | DONE |
...
**Next OPEN:** **R235** — Workspace DocumentStore.
