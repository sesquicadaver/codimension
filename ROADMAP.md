...
| 16 | R204 | Polyglot: UI language controller (capability-driven) | Diagnostics / outline / hover / definition / references / format / rename-preview; no `if language == …` | L | DONE |
...
**Next OPEN:** **R205** (Tree-sitter StructuralGraph Rust+C++).
