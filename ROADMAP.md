...
| 34 | R222 | Updater: validate every redirect hop + final URL | Custom `HTTPRedirectHandler`; `geturl()` re-checked via trust policy | M | DONE |
...
**Next OPEN:** **R223** — MCP: budget-aware workspace walker.
