...
| 40 | R228 | Blank UUID after load | Reject empty disk UUID or atomically restore loaded UUID to `.cdm3` | S | DONE |
...
**Next OPEN:** **R229** — Polyglot capabilities match providers.
