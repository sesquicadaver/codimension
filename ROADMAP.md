...
| 13 | R201 | Polyglot: DocumentSnapshot + LspPositionCodec | Internal Unicode offsets only; per-process encoding; versioned edits reject stale | M | DONE |
...
**Next OPEN:** **R202** (LspProcess stdio JSON-RPC + spawn gate).
