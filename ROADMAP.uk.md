...
| 36 | R224 | LSP DocumentStore для foreign URI spans | Cross-file definition/refs/rename з реальними ranges (не `SourceSpan(0,0)`) | L | DONE |
...
**Наступний OPEN:** **R225** — Plugin manifest policy fail-closed.
