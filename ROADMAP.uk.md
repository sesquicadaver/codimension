...
| 48 | R236 | Project lifecycle façade | create/load/switch/unload лише через `ApplicationServices` (fix bypass `createNew`) | M | DONE (PR pending) |
...
**Наступний OPEN:** **R237** — AI redirect trust.
