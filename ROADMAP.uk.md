...
| D-R179 | R179 | Встановлення відсутніх `-m` інструментів у project venv (діалог; IDE — opt-in) |
...
|---|----|--------|------------|------|--------|
| 1 | R179 | Встановити відсутній інструмент у project venv | Діалог Install / Use IDE once / Cancel; pip у mutable project Python; драйвери; тести | S | OPEN |
...
**R179** (встановлення відсутніх інструментів аналізу в project venv). Далі deferred **R180** / **R181** / **R182** — лише за явним запитом.
