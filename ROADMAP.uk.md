...
| 65 | R253 | Generation-atomic document request | didOpen/didChange + semantic request on one lease; restart re-syncs | L | DONE |
...
**Наступний OPEN:** **R254** — Fail-closed plugin package identity.
