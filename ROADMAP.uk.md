...
| 35 | R223 | MCP: budget-aware workspace walker | Depth/file/byte limits під час обходу; chunked reads; stop on exceed | M | DONE |
...
**Наступний OPEN:** **R224** — LSP DocumentStore for foreign URI spans.
