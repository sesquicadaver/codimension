...
| 45 | R233 | LSP generation-safe lifecycle | Atomic restart+initialize; жодних requests до handshake; clear `_opened` на generation bump | M | DONE |
...
**Наступний OPEN:** **R234** — LSP pending synchronization.
