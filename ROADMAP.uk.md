...
| 46 | R234 | LSP pending synchronization | `_pending_lock`; ключі `(generation, id)`; race tests timeout/shutdown/old-reader | L | DONE |
...
**Наступний OPEN:** **R235** — Workspace DocumentStore.
