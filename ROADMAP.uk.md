...
| 73 | R261 | SSH replace state machine hardening | Немає crash з втратою єдиної valid copy; atomic bound marker; fault tests | L | DONE |
...
**Наступний OPEN:** **R262** — Generation-pinned LSP notifications.
