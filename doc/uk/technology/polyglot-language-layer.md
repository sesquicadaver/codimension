...
| FFI Binding Index | `core/bindings.py` + `infrastructure/ffi_bindings.py` (R206 + **R217**: PyO3 / pybind11 / CPython / `.pyi`; `EXACT` лише з повним registration chain; інакше `BRIDGE`/`INLINE`) |
