# Документація Codimension (українська) — для розробників
...
Цей індекс — для **розробників**. Help у IDE відкриває лише [user/index.md](../user/index.md).
...
## Плагіни та CI (артефакти розробки)
