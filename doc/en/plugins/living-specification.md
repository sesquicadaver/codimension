...
| **AI UI R152** | core.ai_ui + editor.editorcontextmenus + ui.aisettingsdlg + Options | Options top-level Enable AI / AI settings…; editor AI menu; `ai_ui` / `CDM_AI_UI`; offline | tests/test_ai_ui.py, test_ai_options_menu.py |
