...
| **Update check R172 / R215** | utils.update_check + update_provenance + ui.mainmenu/mainwindow | GitHub Releases read-only; trusted HTTPS host/path; size-capped JSON; newer tag dialog | tests/test_update_check.py; tests/test_update_provenance_r215.py; [release-channels.md](../../technology/release-channels.md) |
| **Update download R173 / R215** | utils.update_download + update_provenance + ui.mainwindow | Cache download; SHA-256 fail closed; trusted download hosts; stream + size budgets; ``manifest.json`` | tests/test_update_download.py; [release-channels.md](../../technology/release-channels.md) |
...
Further queue: [ROADMAP.md](../../../ROADMAP.md) — **R222** (Updater redirect hop trust); wave R221–R231 (`codi-last.md` @ 8824ff3c).
