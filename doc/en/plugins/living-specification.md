...
| **SSH remote project open/create** | utils.ssh_remote + ui.sshprojectdlg + ui.sshbrowse | Host profiles; Paramiko/Fake SFTP; R183 path containment; R184 host-key RejectPolicy + fingerprint pin + TOFU UI; remote Browse… | tests/test_ssh_remote_project.py; [ssh-remote-project.md](../../technology/ssh-remote-project.md) |
