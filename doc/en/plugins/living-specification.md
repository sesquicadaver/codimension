...
| **MCP backend R182 / R214** | mcp_backend + optional ``mcp`` SDK | stdio MCP over headless core; ``CDM_MCP_TOKEN`` fail-closed; immutable ``--workspace`` / ``CDM_MCP_WORKSPACE`` + file/byte/depth budgets; 7 MVP tools | tests/test_mcp_r182.py; [mcp-backend.md](../../technology/mcp-backend.md) |
...
Further queue: [ROADMAP.md](../../../ROADMAP.md) — **R223** (MCP budget-aware walker); wave R221–R231 (`codi-last.md` @ 8824ff3c).
