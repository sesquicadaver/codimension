...
| **Polyglot layer R200+** | core.language/semantic/structural/bindings/dependency_edges/cross_language_nav/tasks/document_store/…; infrastructure.lsp_* + file_uri + python_semantic + tree_sitter_structural + ffi_bindings + ffi_structural + build_tasks; app.language_services; ui.language_controller | Registry→…→BindingIndex→typed deps/cross-nav→TaskProviders; Stage 1–4 = R200–R208; R209 lifecycle; **R233** generation-safe restart+initialize; **R234** pending lock + generation keys; R210 server→client; R217/R226/**R240** FFI EXACT (edge-specific structural identity); **R224/R235** DocumentStore (workspace-shared, versioned edits, bounded loader); **R225** plugin manifest; **R229** caps match provider APIs; **R230** IDE workspace attach/detach; **R242** editor buffer sync + capability-driven goto-def/occurrences + Python headless semantic | tests/test_language_r200.py … r210.py; test_language_r224.py; test_language_r235.py; test_language_r206.py; test_language_r226.py; test_language_r240.py; test_language_r229.py; test_language_r230.py; test_language_r233.py; test_language_r234.py; test_language_r242.py; [polyglot-language-layer.md](../../technology/polyglot-language-layer.md); R200–R210 + R217 + R224–R226 + R229–R230 + R233–R235 + R240 DONE |
