...
| **Taint MVP R143** | core.taint | Function-local sources→sinks; R194 `heuristic`+`confidence`; **R227** `posonlyargs` + may-taint branch join; **R239** forward CFG (no whole-list re-exec; throw-point try; match no-match; loop-else) | tests/test_taint.py, test_taint_r239.py; [taint-mvp.md](../uk/technology/taint-mvp.md) |
...
Подальша черга: [ROADMAP.uk.md](../../ROADMAP.uk.md) — хвиля R221–R231 ✅; **R232–R255** ✅; хвиля **R252–R260** (`codi-last.md` @ eaa3dfee); Next = **R256** LSP/URI residual hardening.
