...
| **SSH remote project open/create** | utils.ssh_remote + ui.sshprojectdlg + ui.sshbrowse | Профілі; Paramiko/Fake SFTP; remote Browse…; локальний кеш; меню Open/Create | tests/test_ssh_remote_project.py; [ssh-remote-project.md](../technology/ssh-remote-project.md) |
