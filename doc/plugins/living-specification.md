...
| **Local deploy ctl** | scripts/codimension_ctl.sh | install/uninstall/status/run for `.venv`; optional desktop; `--purge-config` | manual: `./scripts/codimension_ctl.sh status` |
