...
| **Polyglot layer R200+** | core.language/semantic/structural/bindings/…; infrastructure.lsp_* + tree_sitter_structural + ffi_bindings; app.language_services; ui.language_controller | Registry→codec→LspProcess→Semantic→UI→StructuralGraph→BindingIndex; Stage 1–4 = R200–R208 | tests/test_language_r200.py … r206.py; [polyglot-language-layer.md](../technology/polyglot-language-layer.md); R200–R206 DONE |
...
Подальша черга: [ROADMAP.uk.md](../../ROADMAP.uk.md) — **R207→**; лінійна неблокуюча.
