...
| **Polyglot layer R200+** | core.language + document_snapshot; infrastructure.lsp_position_codec; app.language_services | Registry + Python stub; DocumentSnapshot + LspPositionCodec (Unicode↔UTF-8/16/32); Stage 1–4 = R200–R208 | tests/test_language_r200.py, test_language_r201.py; [polyglot-language-layer.md](../technology/polyglot-language-layer.md); R200–R201 DONE |
...
Подальша черга: [ROADMAP.uk.md](../../ROADMAP.uk.md) — **R202→**; лінійна неблокуюча.
