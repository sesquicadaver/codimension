...
| **AI UI R152** | core.ai_ui + editor.editorcontextmenus + ui.aisettingsdlg + Options | Options → AI Enable/settings; ПКМ AI (settings/explain/suggest); `ai_ui` / `CDM_AI_UI`; offline | tests/test_ai_ui.py |
