...
| **Polyglot layer R200+** | core.language/semantic/structural/bindings/dependency_edges/cross_language_nav/tasks/document_store/…; infrastructure.lsp_* + file_uri + tree_sitter_structural + ffi_bindings + ffi_structural + build_tasks; app.language_services; ui.language_controller | Registry→…→BindingIndex→typed deps/cross-nav→TaskProviders; Stage 1–4 = R200–R208; R209 lifecycle; **R233** generation-safe restart+initialize; **R234** pending lock + generation keys; R210 server→client; R217/R226 FFI EXACT (structural); **R224/R235** DocumentStore (workspace-shared, versioned edits, bounded loader); **R225** plugin manifest; **R229** caps match provider APIs; **R230** IDE workspace attach/detach | tests/test_language_r200.py … r210.py; test_language_r224.py; test_language_r235.py; test_language_r206.py; test_language_r226.py; test_language_r229.py; test_language_r230.py; test_language_r233.py; test_language_r234.py; [polyglot-language-layer.md](../technology/polyglot-language-layer.md); R200–R210 + R217 + R224–R226 + R229–R230 + R233–R235 DONE |
...
Подальша черга: [ROADMAP.uk.md](../../ROADMAP.uk.md) — хвиля R221–R231 ✅; активна **R232–R243** (`codi-last.md` @ 45e33f6); Next = **R240** (R232–R239 ✅).
