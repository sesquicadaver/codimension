...
| **SSH remote project open/create** | utils.ssh_remote + ui.sshprojectdlg | Профілі хостів; Paramiko/Fake SFTP; локальний кеш; меню Project Open/New remote | tests/test_ssh_remote_project.py; [ssh-remote-project.md](../technology/ssh-remote-project.md) |
