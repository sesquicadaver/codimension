...
- Qt offscreen smoke у PR CI створює `CodimensionApplication` + `CodimensionMainWindow` і завантажує bundled plugins; код за замовчуванням робить normal interpreter exit (R274), а CI виставляє `CDM_SMOKE_HARD_EXIT=1` доки PyQt atexit не стабільний
